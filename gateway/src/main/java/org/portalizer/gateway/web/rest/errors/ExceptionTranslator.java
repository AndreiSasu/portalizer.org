package org.portalizer.gateway.web.rest.errors;

import io.github.jhipster.web.util.HeaderUtil;

import org.portalizer.gateway.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAreadyUsedException(org.portalizer.gateway.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(org.portalizer.gateway.service.InvalidPasswordException ex, NativeWebRequest request) {
